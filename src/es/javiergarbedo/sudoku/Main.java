...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        setTitle("Sudoku");
        jLabelLevel.setText(mybundle.getString("nivel"));
        ...
        try {
            ...
            lastLevel = properties.getProperty("last_level", "0");
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        try {
            properties.store(new BufferedWriter(new FileWriter("sudoku.properties")), "Archivo del ultimo nivel");
        } catch (IOException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
